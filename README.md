...
``` 
    implementation 'com.github.AbdallahDafa:hyperpay_sdk_library_3ds:v1.0.35' 
    implementation 'com.github.AbdallahDafa:hyperpay_sdk_library_3ds:1.0.35:ipworks3ds_sdk@aar'
```
